...
const (
	finalizerString = "finalizers.dynamodb.services.k8s.aws/Backup"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("backups")
